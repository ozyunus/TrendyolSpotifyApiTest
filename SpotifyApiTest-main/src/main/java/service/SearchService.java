...
public class SearchService extends RequestSpec {
    ...
    public String getArtistUri(Response searchResponse){
        ArrayList arrayList = searchResponse.path("artist.items.uri");
        return arrayList.get(0).toString();
    }

    public String getArtistItems(Response searchResponse){
        ArrayList arrayList = searchResponse.path("artist.items");
        return arrayList.get(0).toString();
    }
}
